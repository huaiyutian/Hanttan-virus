function [dates, alpha1, alpha2, alpha3,alpha1hat, alpha2hat, alpha3hat, tau1, tau2, tau3, tau1hat, tau2hat, tau3hat, logbetarain,logbetatemp, betalongterm, Y0, GRhat,Y,Yhat,RNdensity1,RNhat,  r2_logRN,r2_RN,r2_GR, exitflag2] = fit_model_RN_tempmax(dataset, nknots, h, penalty, saveBool)
...
if saveBool
    filename = strcat('Opt_Results_RN_tempmax_', dataset);
