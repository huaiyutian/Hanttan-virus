function [dates, alpha1, alpha2, alpha3,alpha1hat, alpha2hat, alpha3hat,tau1, tau2, tau3, tau1hat, tau2hat, tau3hat, logbetarain,logbetatemp, betalongterm, Y0, GRhat, Y,Yhat,AAdensity1,AAhat, r2_logAA, r2_AA, r2_GR, exitflag] = fit_model_AA(dataset, nknots, h, penalty, saveBool)
