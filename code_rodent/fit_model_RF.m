function [dates, alpha1, alpha2, alpha3,alpha1hat, alpha2hat, alpha3hat, tau1, tau2, tau3, tau1hat, tau2hat, tau3hat, logbetarain,logbetatemp, betalongterm, Y0, GRhat,Y,Yhat,RFdensity1,RFhat, r2_logRF,r2_RF,r2_GR, exitflag3] = fit_model_RF(dataset, nknots, h, penalty, saveBool)
